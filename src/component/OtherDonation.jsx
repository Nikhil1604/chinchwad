...
const OtherDonation = () => {
  return (
    <div className='px-5 py-3'>
       ...
       <p className='text-start fs-3 fw-semibold'>Other Donation Recipt</p>
          ...
          <div style={{display:'flex',flexDirection:'column'}}>
            ...
            <div className='py-1' style={{display:'flex',flexDirection:'row',alignItems:'start'}}>
              ...
              <div style={{flex:'6',display:'flex',flexDirection:'column'}}>
                  <div style={{display:'flex',flexDirection:'row'}}>
                    <div style={{flex:'6'}}>
                      <p className='fs-6 fw-semibold'>Recipt Type</p>
                    </div>
                    <div style={{flex:'6'}}>
                  ...
                  <div className='py-2' style={{display:'flex',flexDirection:'row'}}>
                      <div style={{flex:'6'}}>
                      <p className='fs-6 fw-semibold'>Abhishek Date</p>
                      </div>
                      <div style={{flex:'6'}}>
                        <input type="date" className='form-control w-75' placeholder='12/02/2024' />
                      </div>
            ...
            <div className='py-1' style={{display:'flex',flexDirection:'row',alignItems:'center'}}>             
              <div style={{flex:'3'}}>
                <p className='fs-6 fw-semibold'>Gotra</p>
              </div>
              <div style={{flex:'3'}}>
                <input className='form-control w-75'  type="text" placeholder='032158' />
              </div>
